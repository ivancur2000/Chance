        ...
        <div class="overflow-x-auto">
            <table class="table-auto w-full">
                <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                        <th class="p-2 whitespace-nowrap">
                            <div class="font-semibold text-left">Instituto</div>
                        </th>
                        <th class="p-2 whitespace-nowrap">
                            <div class="font-semibold text-left">Nivel Academico</div>
                        </th>
                        <th class="p-2 whitespace-nowrap">
                ...
                <tbody class="text-sm divide-y divide-gray-100">
                    @foreach ($academiTraining as $academi)
                    <tr>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left">{{ $academi->institution }}</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left">{{ $academi->academic_level }}</div>
                        </td>
                        <td class="p-2 whitespace-nowrap">
                            <div class="text-left">{{
