    ...
    data: {
      ...
      datasets: [
        // Line
        {
          ...
          fill: true,
          backgroundColor: `rgba(${hexToRGB(fullConfig.theme.colors.rose[500])}, 0.08)`,
          borderColor: fullConfig.theme.colors.rose[500],
          borderWidth: 2,
          tension: 0,
          pointRadius: 0,
          pointHoverRadius: 3,
          pointBackgroundColor: fullConfig.theme.colors.rose[500],
          clip: 20,
        },
      ],
    },
